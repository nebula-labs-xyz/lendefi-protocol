...
contract LendefiTest is BasicDeploy {
    ...
    function test_Revert_BorrowExceedingIsolationDebtCap() public {
        ...
        assetsInstance.updateAssetConfig(
            ...
            IASSETORACLE.CollateralTier.ISOLATED, // Tier
    ...
    function test_InterestRateScaling() public {
        ...
        uint256 rate1 = LendefiInstance.getBorrowRate(IASSETORACLE.CollateralTier.CROSS_A);
        ...
        uint256 rate2 = LendefiInstance.getBorrowRate(IASSETORACLE.CollateralTier.CROSS_A);
