...
contract BorrowTest is BasicDeploy {
    ...
    function _setupAssets() internal {
        ...
        assetsInstance.addOracle(address(wethInstance), address(wethassetsInstance), 8);
        assetsInstance.setPrimaryOracle(address(wethInstance), address(wethassetsInstance));

        assetsInstance.addOracle(address(rwaToken), address(rwaassetsInstance), 8);
    ...
    function test_BorrowIsolationDebtCap() public {
        ...
        IASSETORACLE.Asset memory asset = assetsInstance.getAssetInfo(address(rwaToken));
    ...
    function test_BorrowMultiplePositions() public {
        ...
        // Get positions directly through getUserPosition instead of getPositionDebt
    ...
    function test_BorrowIsolatedTier() public {
        ...
        // Get isolated rate
        uint256 isolatedRate = LendefiInstance.getBorrowRate(IASSETORACLE.CollateralTier.ISOLATED);
    ...
    function test_BorrowCrossBTier() public {
        ...
        RWAPriceConsumerV3 crossBassetsInstance = new RWAPriceConsumerV3();
        crossBassetsInstance.setPrice(500e8); // $500 per token
        ...
        // Get cross B rate
        uint256 crossBRate = LendefiInstance.getBorrowRate(IASSETORACLE.CollateralTier.CROSS_B);
    ...
    function test_BorrowCrossATier() public {
        ...
        // Get cross A rate
        uint256 crossARate = LendefiInstance.getBorrowRate(IASSETORACLE.CollateralTier.CROSS_A);
    ...
    function testFuzz_MultipleBorrows(uint256 numBorrows, uint256 initialBorrowPct) public {
        ...
        IPROTOCOL.UserPosition memory position = LendefiInstance.getUserPosition(bob, positionId);
        uint256 finalDebt = position.debtAmount;
