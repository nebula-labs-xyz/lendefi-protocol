...
contract AssetsInitializeTest is BasicDeploy {
    ...
    function setUp() public {
        ...
        oracleAddr = address(assetsInstance);
    ...
    function test_TierParameterPrecision() public {
        ...
        assertEq(
            assetsContract.getTierLiquidationFee(IASSETORACLE.CollateralTier.ISOLATED),
            0.04e6,
            "ISOLATED liquidation fee should be precisely 0.04e6"
        );

        assertEq(
            assetsContract.getTierJumpRate(IASSETORACLE.CollateralTier.STABLE),
            0.05e6,
    ...
    function test_PauseStateAfterInit() public {
        ...
        assetsInstance.addOracle(address(wethInstance), mockPriceFeed, 8);
        assetsInstance.setPrimaryOracle(address(wethInstance), mockPriceFeed);
