...
contract LendefiExtendedTest is BasicDeploy {
    ...
    function test_FullPositionLifecycle() public {
        ...
        uint256 borrowRate = LendefiInstance.getBorrowRate(IASSETORACLE.CollateralTier.CROSS_A);
        ...
        uint256 tierRate = LendefiInstance.getBorrowRate(IASSETORACLE.CollateralTier.CROSS_A);
    ...
    // Fixed - Using proper IASSETORACLE.OracleInvalidPrice error
    function test_OracleFailures() public {
        ...
        // Use custom error from IASSETORACLE interface
        vm.expectRevert(
            abi.encodeWithSelector(IASSETORACLE.OracleInvalidPrice.selector, address(wethassetsInstance), 0)
        );
    ...
    function test_ParameterUpdates() public {
        ...
        assetsInstance.updateTierParameters(IASSETORACLE.CollateralTier.CROSS_A, 0.1e6, 0.1e6);
    ...
    // Fixed - Using proper IASSETORACLE.OracleTimeout error
    function testRevert_OracleTimeout() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IASSETORACLE.OracleTimeout.selector,
