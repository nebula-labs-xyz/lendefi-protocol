...
contract CreatePositionTest is BasicDeploy {
        ...
        assetsInstance.updateAssetConfig(
            ...
            IASSETS.Asset({
                ...
                chainlinkConfig: IASSETS.ChainlinkOracleConfig({
                    oracleUSD: address(rwaassetsInstance),
    ...
    function test_CreateIsolatedPositionWithNonIsolatedAsset() public {
        ...
        // In the optimized version of the contract, it succeeds but sets the position correctly
    ...
    function test_CreatePositionWhenPaused() public {
        ...
        // Try to create a position when paused - UPDATED: Use OpenZeppelin's Pausable error
