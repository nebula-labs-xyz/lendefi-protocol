...
contract WithdrawCollateralTest is BasicDeploy {
    ...
    function test_WithdrawFromMultiAssetPosition() public {
        ...
        uint256 wethCollateral = LendefiInstance.getCollateralAmount(bob, positionId, address(wethInstance));
        uint256 stableCollateral = LendefiInstance.getCollateralAmount(bob, positionId, address(stableToken));
